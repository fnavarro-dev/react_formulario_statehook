...
//Datos iniciale son nulos, el useState cambiará su valor
...
const FormularioUsuario = ({ userAdd, usuarioEditado, setUsuarioEditado, userEdit }) => {
  ...
  //NO CRANEAR TANTO ESTA FUNCIÓN. La e es por documentación 
  const handleInputChange = (e) => {
    //esta funcion se llama cada vez que nosotros escribirmos algo en algun input de
    //nuestra página
  ...
  return (
    <div class="card container mb-2 bg-transparent text-white">
      <form>
        {/* hacemos que el mensaje del formulario sea dinamico
    segun si queremos editar o ingresar Preguntamos con ? y si es aplica el
    primer valor, y si no es, aplica segundo valor */}
        {usuarioEditado !== null ? (
